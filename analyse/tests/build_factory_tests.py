...
class BuildFactoryTest(TestCase):
    ...
    def testToParseAllTheLogs(self):
        self.assertEqual(2, len(Builds.create_builds("connectfour4", BuildFactoryTest.PATTERN)))

    def testToParseTheInformationCorrectly(self):
        builds = Builds.create_builds("connectfour4", BuildFactoryTest.PATTERN);
    ...
    def testShouldNotThrowExceptionWhenProcessingXmlFile(self):
        ...
        builds = Builds.create_builds("cclive-release-jdk1.5", "log20080624064201Lbuild.70.xml")
